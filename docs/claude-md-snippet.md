<!--
Copy the section below into your own CLAUDE.md (or equivalent
agent-instructions file) -- wherever you keep it. Suggested: your
top-level / global guidance file (e.g. ~/.claude/CLAUDE.md for Claude
Code), since this guidance applies to how you use this MCP server across
every project, not just one. It is scoped to you as an operator, not to
this repo -- this file just ships it in one copyable place.
-->
